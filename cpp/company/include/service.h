...
public:
	 ...
	 * @return
	*/
	ResultEntity<PageInfo<Department>> getPageInfo(string page_no = "1", string page_size = "5");
...
public:
	 ...
	 * @return
	*/
	ResultEntity<PageInfo<Employee>> getPageInfo(string page_no = "1", string page_size = "5");
...
public:
	ResultEntity<PageInfo<Role>> getList(const string &page_no = "1", const string &page_size = "5");
};
...
public:
	 ...
	 * @return
	*/
	ResultEntity<System> login(string username, string password, const string &code);
