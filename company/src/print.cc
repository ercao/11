...
ostream &Printer::print(const shared_ptr<Employee> &e) {
	...
	return cout << left << "|"
		<< setw(WIDTH) << e->id() << "|"
		<< setw(WIDTH) << e->username() << "|"
		<< setw(WIDTH) << e->password() << "|"
		<< setw(WIDTH) << e->name() << "|"
		<< setw(WIDTH) << e->gender() << "|"
		<< setw(WIDTH) << e->age() << "|"
		<< setw(WIDTH) << e->workedTime() << "|"
		<< setw(WIDTH) << e->salary() << "|"
		<< setw(WIDTH) << e->departmentName() << "|"
		<< setw(WIDTH) << e->roleName() << "|"
		<< setw(WIDTH) << e->createTime() << "|"
